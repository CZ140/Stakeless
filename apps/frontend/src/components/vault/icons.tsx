...
export const FlipIcon = ({ size = 18 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...stroke}>
    <ellipse cx="12" cy="12" rx="5.5" ry="9" />
    <path d="M12 3 C8.5 3 8.5 21 12 21" />
    <path d="M12 3 C15.5 3 15.5 21 12 21" />
  </svg>
);

export const HiloIcon = ({ size = 18 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...stroke}>
    <rect x="8" y="5" width="8" height="14" rx="1.6" />
    <path d="M5 9 L3 7 L1 9" />
    <path d="M19 15 L21 17 L23 15" />
  </svg>
);

export const PumpIcon = ({ size = 18 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...stroke}>
    <ellipse cx="10" cy="9" rx="6" ry="7" />
    <path d="M10 16 L10 20" />
    <path d="M19 4 L19 9 M16.5 6.5 L21.5 6.5" />
  </svg>
);

export const ChickenIcon = ({ size = 18 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" {...stroke}>
    <path d="M4 18 L20 18" />
    <path d="M7 18 L7 21 M13 18 L13 21 M18 18 L18 21" />
    <circle cx="11" cy="9" r="4" />
    <path d="M11 4.5 L10 3 M11 4.5 L12 3" />
    <path d="M15 9 L17.5 9.6" />
  </svg>
);
