...
// (aria-hidden) — a large European single-zero wheel that rotates slowly, with
// a fixed (non-rotating) light/shadow overlay for a 3D feel. Ported from the
// "Auth + Account" design handoff.
