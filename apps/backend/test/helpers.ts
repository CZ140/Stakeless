...
export async function resetDb(): Promise<void> {
  await db.execute(
    sql`TRUNCATE TABLE users, game_logs, game_sessions, refresh_tokens, email_verification_tokens, daily_bonus_claims, admin_logs, friendships RESTART IDENTITY CASCADE`,
  );
}
